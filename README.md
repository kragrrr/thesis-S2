...
|-------|-----------|---------------|-------------|
| Stage 0 (detection) | 512 px | 16 | ~8–16 GB (FP32, no mosaic, yolo26x) |
| Stage 1 (binary cls) | 64 px | 1024 | ~6–12 GB (yolo26x-cls) |
| Stage 2 (defect cls) | 64 px | 1024 | ~6–12 GB (yolo26x-cls) |
